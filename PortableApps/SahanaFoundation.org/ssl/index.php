...
?>
  ...
  <div id="content">
    ...
    <p>Welcome to the Uniform Server default start page. This page and every other file are being served from the main server root folder, "/ssl/". <br /> Additional support for 7-Orion see 5-Nano series found on the <a target="_1" href="http://wiki.uniformserver.com/index.php/Category:Uniform_Server_5.0-Nano">Wiki</a>.</p>
    <p>&nbsp;</p>
 ...
 <table>
   ...
   <td>
    <ul>
      <li> Apache 2.2.21</li>
      <li> MySQL 5.5.18-community</li>
      <li> PHP 5.3.8</li>
      <li> eAccelerator 1.0-snv427</li>
      <li> phpMyAdmin 3.4.7.1</li>
   ...
   <td>
    <ul>
      ...
      <li> msmtp 1.4.25 - Mail client for PHP  </li>
    </ul>
   </td>
   </tr>
  </table>
