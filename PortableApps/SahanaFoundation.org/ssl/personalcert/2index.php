...
<div id="wrap">
  ...
  <div id="menu">
  <a href="http://localhost/apanel/">Server Administration</a> - 
  <a href="http://localhost">Back to Non-Secure</a></div>
  <div id="content">
    <h2>Welcome to Uniform Server</h2>
    <p>Welcome to the Uniform Server defualt start page. This page and every other file are being served from the main server root folder, "/www/". <br /> Additional support can be found on the <a href="http://wiki.uniformserver.com">Wiki</a>.</p>
    <p>&nbsp;</p>
